...
contract Host {
    ...
    function createEvent(string memory _eventName, string memory _location, uint256 _date, 
        uint256 _totalSupply, string memory _tokenName, string memory _symbol, uint256 _decimals, uint256 _price
        ) public {
        address sender = msg.sender;
        address c =  address(new Event( _totalSupply,_tokenName,_symbol,_decimals,_price,sender));
    ...
    function getEvents(address oaddress) public view returns (address[] memory){
