...
contract Event {
    ...
    constructor ( 
        uint256 _totalSupply, string memory _typeName, string memory _symbol, uint256 _decimals, uint256 _price, address _sender) public{
        address c = address(new ERC20(_totalSupply,_typeName,_symbol,_decimals,_price));
    ...
    function addToken(uint256 _totalSupply, string memory _typeName, string memory _symbol, uint256 _decimals, uint256 _price) public{
